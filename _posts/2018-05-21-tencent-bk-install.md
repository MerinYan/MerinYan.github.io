...
[root@rbtnode1 data]# wget http://central.maven.org/maven2/com/github/dblock/waffle/waffle-jna/1.7.5/waffle-jna-1.7.5.jar -O src/bkdata/databus/lib/company/mysql-connector-java-5.1.38.jar
...
[root@rbtnode1 job]# wget http://central.maven.org/maven2/com/rabbitmq/amqp-client/4.0.3/amqp-client-4.0.3.jar
[root@rbtnode1 job]# wget http://central.maven.org/maven2/c3p0/c3p0/0.9.1.1/c3p0-0.9.1.1.jar
[root@rbtnode1 job]# wget http://central.maven.org/maven2/org/eclipse/jdt/ecj/3.12.3/ecj-3.12.3.jar
[root@rbtnode1 job]# wget http://central.maven.org/maven2/javax/servlet/javax.servlet-api/3.1.0/javax.servlet-api-3.1.0.jar
[root@rbtnode1 job]# wget http://central.maven.org/maven2/org/jboss/marshalling/jboss-marshalling/1.3.0.CR9/jboss-marshalling-1.3.0.CR9.jar
[root@rbtnode1 job]# wget http://central.maven.org/maven2/org/jboss/marshalling/jboss-marshalling-serial/1.3.0.CR9/jboss-marshalling-serial-1.3.0.CR9.jar
[root@rbtnode1 job]# wget http://central.maven.org/maven2/net/sourceforge/jchardet/jchardet/1.0/jchardet-1.0.jar
[root@rbtnode1 job]# wget http://central.maven.org/maven2/ch/qos/logback/logback-access/1.1.11/logback-access-1.1.11.jar
[root@rbtnode1 job]# wget http://central.maven.org/maven2/ch/qos/logback/logback-classic/1.1.11/logback-classic-1.1.11.jar
[root@rbtnode1 job]# wget http://central.maven.org/maven2/ch/qos/logback/logback-core/1.1.11/logback-core-1.1.11.jar
[root@rbtnode1 job]# wget http://central.maven.org/maven2/mysql/mysql-connector-java/5.1.39/mysql-connector-java-5.1.39.jar
[root@rbtnode1 lib]# zip -u0 ../../job-exec.war *.jar
